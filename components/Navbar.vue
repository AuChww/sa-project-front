    ...
    <nav class="dark:bg-blue-800 p-4 sticky top-0 z-50">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden lg:flex space-x-4">
            ...
            <div class="relative inline-block text-left">
              <div>
                <button @click="toggleNotify" type="button" class="p-1.5 inline-flex text-white rounded-lg hover:bg-green-100 dark:hover:bg-blue-500 group" id="menu-button" aria-expanded="true" aria-haspopup="true">
                  ...
                  <span class="animate-ping inline-flex items-center justify-center ml-1 w-3 h-3 p-3 text-sm font-medium text-blue-300 bg-red-100 rounded-full dark:bg-red-500 dark:text-white">1</span>
                </button>
              </div>
              ...
              <div v-if="notifyOpen" class=" absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                <div class="py-1 inline-flex" role="none" >
                  ...
                  <span class="inline-flex items-center justify-center animate-pulse w-3 h-3 p-3 mt-1 text-sm font-medium text-blue-300 bg-red-100 rounded-full dark:bg-red-500 dark:text-white">1</span>
                </div>
                <div class="py-1" role="none">
                  <div class="text-gray-700 block px-4 py-2 text-sm">
                    <span class="inline-flex items-center justify-center animate-pulse w-3 h-3 p-3 mt-1 text-sm font-medium text-blue-300 bg-red-100 rounded-full dark:bg-red-500 dark:text-white">new</span>
          ...
          <div class="inline-flex items-center">            
            <button v-if="auth.isLogin" class="p-1.5 inline-flex text-white rounded-lg hover:bg-green-100 dark:hover:bg-blue-500 group8" @click="onLogout()">
                Logout
      ...
      <div v-if="isMobileMenuOpen" class="lg:hidden space-x-4">
          ...
          <!-- delivery -->
          <router-link to="/product/product-check" v-if="auth.checkRole('Delivery')" class="p-1.5 text-white rounded-lg hover:animate-bounce hover:bg-green-100 dark:hover:bg-blue-500 group mx-8">Check Product</router-link>

          <!-- audit -->
          <router-link to="/order/" v-if="auth.checkRole('Audit')" class="p-1.5 text-white rounded-lg hover:animate-bounce hover:bg-green-100 dark:hover:bg-blue-500 group mx-8">Order Check</router-link>
          <router-link to="/order/refund-check" v-if="auth.checkRole('Audit')" class="p-1.5 text-white rounded-lg hover:animate-bounce hover:bg-green-100 dark:hover:bg-blue-500 group mx-8">Refund Check</router-link>
