                ...
                <div class="flex-auto p-5">
                    <div class="relative flex flex-col justify-center">
                        ...
                        <div class="relative mb-6">
                            ...
                            <div
                                v-if="order.status == 'Preparing' || order.status == 'Packing' || order.status == 'Delivering' || order.status == 'Complete'">
                                <span
                        ...
                        <div class="relative mb-6">
                            ...
                            <div
                                v-if="order.status == 'Packing' || order.status == 'Delivering' || order.status == 'Complete'">
                                <span
                        ...
                        <div class="relative mb-6">
                            ...
                            <div class="ml-12 w-auto pt-1">
                                <h6 class="text-sm font-semibold text-blue-900">Complete</h6>
                                <p class="mt-1 text-xs text-gray-500"></p>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 mx-auto items-center">
                        <div v-if="order.status == 'Pending' || order.status == 'Preparing' || order.status == 'Packing'">
                            <button
                                class="w-full z-4 items-center py-4 border-2 bg-white border-red-400 lg:rounded-2xl text-red-400 hover:text-white hover:border-white hover:bg-red-500">
                                <div class="">
                                    Cancel
                                </div>
                            </button>
                        ...
                        <div v-if="order.status == 'Delivering'">
                            <button
                                class="w-full z-4 items-center py-4 border-2 bg-white border-emerald-400 lg:rounded-2xl text-emerald-400 hover:text-white hover:border-white hover:bg-emerald-400">
                                <div class="">
                                    Complete
                                </div>
                            </button>
