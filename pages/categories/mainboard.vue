    ...
    <div>
        ...
        <section class="py-2 mx-3" id="RAM"
            ...
            <div class="container mx-auto text-center">
                ...
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    ...
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                        ...
                        <div class="duration-700 ease-in-out" data-carousel-item>
                            <img src="https://setting.ihavecpu.com/uploads/slidebanner/shop1/slide_240.jpg"
                ...
                <div class="text-white mt-12 py-1 bg-gray-900 font-semibold text-2xl mx-2 rounded-lg">Main Board</div>
