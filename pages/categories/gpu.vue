                ...
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    ...
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                        ...
                        <div class="duration-700 ease-in-out" data-carousel-item>
                            <img src="https://setting.ihavecpu.com/uploads/slidebanner/shop1/slide_237.jpg"
                    ...
                    <section class="mt-4 mx-4" id="Feature Video">
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                            ...
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/IAjMJ5sMKPY" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/A3DThbufQ-w" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/A3DThbufQ-w" class="w-full h-full"
                            ...
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/ykDuoq-MpHg" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
