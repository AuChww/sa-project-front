    ...
    <div>
        ...
        <section class="py-2 mx-3" id="RAM"
            ...
            <div class="container mx-auto text-center">
                ...
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    ...
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                        ...
                        <div class="duration-700 ease-in-out" data-carousel-item>
                            <img src="https://setting.ihavecpu.com/uploads/slidebanner/shop1/slide_259.jpg"
                    ...
                    <section class="mt-4 mx-4" id="Feature Video">
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                            ...
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/QFlROqFcMhQ" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/ZBCMijQJ1Mc" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/JMIe3vu4vnc" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/xoI_pAVMgeg" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                ...
                <div class="text-white mt-12 py-1 bg-gray-900 font-semibold text-2xl mx-2 rounded-lg">Display</div>
