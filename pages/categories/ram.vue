    ...
    <div>
        ...
        <section class="py-2 mx-3" id="RAM"
            ...
            <div class="container mx-auto text-center">
                ...
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    ...
                    <section class="py-12 mt-4 mx-4" id="Feature Video">
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                            ...
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/3M1pSJX30g8" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/UDlZj7-5mdQ" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/UDKx4ScVJck" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="w-full">
                                <iframe src="https://www.youtube.com/embed/y4wL-HyxTGg" class="w-full h-full"
                                    frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </section>
                ...
                <div class="text-white mt-12 py-1 bg-gray-900 font-semibold text-2xl mx-2 rounded-lg">RAM</div>
